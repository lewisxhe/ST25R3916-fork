...
/*******************************************************************************/
void RfalRfST25R3916Class::st25r3916Deinitialize(void)
{
  st25r3916DisableInterrupts(ST25R3916_IRQ_MASK_ALL);
...
/*******************************************************************************/
uint16_t RfalRfST25R3916Class::st25r3916MeasureVoltage(uint8_t mpsv)
{
  uint8_t result;
  uint16_t mV;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916AdjustRegulators(uint16_t *result_mV)
{
  uint8_t result;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916MeasureAmplitude(uint8_t *result)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916MeasurePhase(uint8_t *result)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916SetBitrate(uint8_t txrate, uint8_t rxrate)
{
  uint8_t reg;
...
/*******************************************************************************/
void RfalRfST25R3916Class::st25r3916SetNumTxBits(uint16_t nBits)
{
...
/*******************************************************************************/
uint16_t RfalRfST25R3916Class::st25r3916GetNumFIFOBytes(void)
{
  uint8_t  reg;
  uint16_t result;
...
/*******************************************************************************/
uint8_t RfalRfST25R3916Class::st25r3916GetNumFIFOLastBits(void)
{
  uint8_t  reg;
...
/*******************************************************************************/
uint32_t RfalRfST25R3916Class::st25r3916GetNoResponseTime(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916SetNoResponseTime(uint32_t nrt_64fcs)
{
  ReturnCode err;
  uint8_t    nrt_step;
  uint32_t   tmpNRT;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916SetStartNoResponseTimer(uint32_t nrt_64fcs)
{
  ReturnCode err;
...
/*******************************************************************************/
void RfalRfST25R3916Class::st25r3916SetGPTime(uint16_t gpt_8fcs)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916SetStartGPTimer(uint16_t gpt_8fcs, uint8_t trigger_source)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916StreamConfigure(const struct st25r3916StreamConfig *config)
{
  uint8_t smd;
  uint8_t mode;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3916Class::st25r3916GetRSSI(uint16_t *amRssi, uint16_t *pmRssi)
{
  /*******************************************************************************/
